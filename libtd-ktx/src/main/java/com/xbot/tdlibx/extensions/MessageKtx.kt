...
import com.xbot.tdlibx.coroutines.blockMessageSenderFromReplies
...
interface MessageKtx : BaseKtx {
  ...
  ) = api.getChatMessagePosition(chatId, this.id, filter, messageThreadId)
   ...
   */
  suspend fun Message.shareUserWithBot(
    chatId: Long,
    buttonId: Int,
    sharedUserId: Long,
    onlyCheck: Boolean
  ) = api.shareUserWithBot(chatId, this.id, buttonId, sharedUserId, onlyCheck)
