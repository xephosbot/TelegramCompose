...
/**
 * Suspend function, which checks the authentication of a email address. Works only when the current
...
/**
 * Suspend function, which sends a code to verify an email address to be added to a user&#039;s
 * Telegram Passport.
 *
 ...
 * checkLoginEmailAddressCode. To use Apple ID/Google ID instead of a email address, call
