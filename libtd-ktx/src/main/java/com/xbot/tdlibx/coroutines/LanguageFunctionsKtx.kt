 ...
 * target.
 *
 * @param info Information about the language pack. Language pack ID must start with &#039;X&#039;,
 ...
 * current localization target from the server. This method doesn&#039;t need to be called explicitly
