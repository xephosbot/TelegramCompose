 ...
 * contact. A corresponding rule to userPrivacySettingShowPhoneNumber will be added if needed. Use the
 ...
 *
 * @param contacts The list of contacts to import or edit; contacts&#039; vCard are ignored and are
 * not imported.
 *
 * @return [ImportedContacts] Represents the result of an importContacts request.
 */
