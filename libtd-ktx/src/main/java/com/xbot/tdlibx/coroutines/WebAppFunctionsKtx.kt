...
/**
 * Suspend function, which returns an HTTPS URL of a Web App to open after keyboardButtonTypeWebApp
 * or inlineQueryResultsButtonTypeWebApp button is pressed.
 *
 * @param botUserId Identifier of the target bot.  
 * @param url The URL from the keyboardButtonTypeWebApp or inlineQueryResultsButtonTypeWebApp
 * button.  
 * @param theme Preferred Web App theme; pass null to use the default theme.  
 * @param applicationName Short name of the application; 0-64 English letters, digits, and
 * underscores.
 ...
 * must be shown once.
 *
 * @param chatId Identifier of the chat in which the Web App is opened. The Web App can&#039;t be
 ...
 * @param replyToMessageId Identifier of the replied message for the message sent by the Web App; 0
 * if none.
 *
...
suspend fun TelegramFlow.openWebApp(
  ...
  replyToMessageId: Long
    ...
    applicationName, messageThreadId, replyToMessageId))
