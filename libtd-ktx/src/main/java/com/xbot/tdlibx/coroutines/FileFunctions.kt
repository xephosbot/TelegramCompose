 ...
 */
suspend fun TelegramFlow.cleanFileName(fileName: String?): TdApi.Text =
...
suspend fun TelegramFlow.downloadFile(
    ...
    limit: Int,
    synchronous: Boolean
): TdApi.File = this.sendFunctionAsync(TdApi.DownloadFile(fileId, priority, offset, limit, synchronous))
 ...
 */
suspend fun TelegramFlow.finishFileGeneration(generationId: Long, error: TdApi.Error?) =
 ...
 * @return [TdApi.File] Represents a file.
 */
suspend fun TelegramFlow.getFile(fileId: Int): TdApi.File = this.sendFunctionAsync(TdApi.GetFile(fileId))
 ...
 */
suspend fun TelegramFlow.getFileDownloadedPrefixSize(fileId: Int, offset: Int): TdApi.Count =
 ...
 * @return [TdApi.Text] Contains some text.
 */
suspend fun TelegramFlow.getFileExtension(mimeType: String?): TdApi.Text =
 ...
 * @return [TdApi.Text] Contains some text.
 */
suspend fun TelegramFlow.getFileMimeType(fileName: String?): TdApi.Text =
...
suspend fun TelegramFlow.getMapThumbnailFile(
    ...
    scale: Int,
    chatId: Long
): TdApi.File = this.sendFunctionAsync(TdApi.GetMapThumbnailFile(location, zoom, width, height, scale,
    chatId))
 ...
 * @return [TdApi.File] Represents a file.
 */
suspend fun TelegramFlow.getRemoteFile(remoteFileId: String?, fileType: TdApi.FileType?): TdApi.File =
...
suspend fun TelegramFlow.readFilePart(
    ...
    offset: Int,
    count: Int
): TdApi.FilePart = this.sendFunctionAsync(TdApi.ReadFilePart(fileId, offset, count))
...
suspend fun TelegramFlow.setFileGenerationProgress(
    ...
    expectedSize: Int,
    localPrefixSize: Int
) = this.sendFunctionLaunch(TdApi.SetFileGenerationProgress(generationId, expectedSize, localPrefixSize))
...
suspend fun TelegramFlow.uploadFile(
    ...
    priority: Int
): TdApi.File = this.sendFunctionAsync(TdApi.UploadFile(file, fileType, priority))

/**
 * Suspend function, which uploads a PNG image with a sticker; for bots only; returns the uploaded
 * file.
 *
 * @param userId Sticker file owner, ignored for regular user.
 * @param sticker Sticker file to upload.
 *
 * @return [TdApi.File] Represents a file.
 */
suspend fun TelegramFlow.uploadStickerFile(userId: Long, sticker: TdApi.InputSticker?): TdApi.File =
