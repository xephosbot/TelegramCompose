 ...
 *
 * @return [TdApi.Session] Contains information about one session in a Telegram application used by the
 * current user. Sessions should be shown to the user in the returned order.
 */
suspend fun TelegramFlow.confirmQrCodeAuthentication(link: String?): TdApi.Session =
