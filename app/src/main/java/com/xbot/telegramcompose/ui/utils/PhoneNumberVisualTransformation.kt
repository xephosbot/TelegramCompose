...
@Composable
fun phoneNumberVisualTransformation(): PhoneNumberVisualTransformation {
    val context = LocalContext.current
    return remember(context) { PhoneNumberVisualTransformation(context) }
}

class PhoneNumberVisualTransformation (context: Context) : VisualTransformation {

    private val phoneNumberFormatter = CountryPickerUtils.getInstance(context).asYouTypeFormatter
